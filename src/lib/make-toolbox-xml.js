...
const myExtension = function (isInitialSetup, isStage, targetId, colors) {
    return `
    <category
        name="AITHAIGEN"
        id="myBlocks"
...
const makeToolboxXML = function (isInitialSetup, isStage = true, targetId, categoriesXML = [],
    ...
    const myExtensionXML = moveCategory('myExtension') || myExtension(isInitialSetup, isStage, targetId, colors.more);
