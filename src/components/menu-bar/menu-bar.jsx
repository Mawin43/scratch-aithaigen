            ...
            >
                <div className={styles.mainMenu}>
                    <div className={styles.fileGroup}>
                        <a /*href="https://aithaigen.in.th/"*/>
                            <img
                                src='https://cdnaithaigen.sgp1.cdn.digitaloceanspaces.com/web.assets/main/images/AILOGO2.svg'
                                style={{ width: '40px', height: '40px', marginLeft: '10px', marginRight: '10px' }}
                                draggable={false}
                            />
                        </a>
